...
\section{Research Experience}
    \resumeSubHeadingListStart
        ...
        \resumeItemListStart
            \resumeItem{Developed a library of Low-Fidelity Vehicle Models that are 1000x faster that real-time on a CPU}
            \resumeItem{Parallelized the code using CUDA, achieving simulation of 300,000 vehicles in real-time}
            \resumeItem{Used a SWIG wrapper to enable the use of the models in Python}
            \resumeItem{Used Bayesian Optimization to tune the parameters of the model to match real-world data and high-fidelity vehicle models}
...
\section{Publications}
  \resumeSubHeadingListStart
        ...
        \resumeItemListStart
        \resumeItem{\textbf{Unjhawala, H.}, Hansen, T., Zhang, H., Caldraru, S., Chatterjee, S., Bakke, L., Wu, J., Serban, R., Negrut, D., \textbf{An Expeditious and Expressive Vehicle Dynamics Model for Applications in Controls and Reinforcement Learning}, IEEE Access, Preprint \url{https://uwmadison.box.com/s/ee3cnv3ywghjhraazh52xudonyorlg77}}
        \resumeItem{\textbf{Unjhawala, H.}, Mahajan, I., Serban, R., Negrut, D., \textbf{A Graph-Neural Network Based Approach for Fast Terramechanics Simulation}, Journal of Open Source Software, Preprint \url{https://github.com/uwsbel/low-fidelity-dynamic-models/blob/12-complete-paper-for-joss/paper/paper.md}}
        \resumeItem{Zhang, H., Caldararu, S., Ashokkumar, S., Mahajan, I., Young, A., Ruiz, A., \textbf{Unjhawala, H.}, Bakke, L., Negrut, D., \textbf{Zero-Shot Policy Transferability for the Control of a Scale Autonomous Vehicle}, arXiv, Preprint \url{https://arxiv.org/abs/2309.09870}}
        \resumeItemListEnd
    \resumeSubHeadingListEnd
