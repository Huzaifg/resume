...
\section{Research Experience}
    \resumeSubHeadingListStart
      ...
      \resumeProjectHeading
        ...
        \resumeItemListStart
            \resumeItem{Exploring the use of Graph-Neural Network based models for fast terramechanics simulations with the main goal to enable real-time simulation of large-scale terrains for designing the autonomy stacks of construction equipment}
